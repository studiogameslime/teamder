...
exports.cooldownMsFor = cooldownMsFor;
exports.dedupeKeyFor = dedupeKeyFor;
exports.dedupeIdFor = dedupeIdFor;
exports.inferEntityFromPayload = inferEntityFromPayload;
const COOLDOWN_MS = {
...
function dedupeIdFor(input, nowMs = Date.now()) {
...
function inferEntityFromPayload(type, recipientId, payload) {
    ...
    const requesterId = typeof payload.requesterId === 'string'
        ? payload.requesterId
        : '';
    const cancellingUserId = typeof payload.cancellingUserId === 'string'
        ? payload.cancellingUserId
        : '';
    const inviterId = typeof payload.inviterId === 'string'
        ? payload.inviterId
        : '';
    const milestone = typeof payload.milestone === 'string'
        ? payload.milestone
        : '';
    const fromUserId = typeof payload.fromUserId === 'string'
        ? payload.fromUserId
        : '';
    switch (type) {
        case 'joinRequest':
