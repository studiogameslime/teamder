  ...
  'gv2-7': [
    {
      ...
      winnerSide: 'A',
      goals: [
        { scorerId: 'p1', assisterId: 'p3', ownGoal: false, minute: 5, team: 'A' },
        { scorerId: 'p2', assisterId: null, ownGoal: false, minute: 8, team: 'A' },
        { scorerId: 'p1', assisterId: 'p4', ownGoal: false, minute: 11, team: 'A' },
        { scorerId: 'p6', assisterId: null, ownGoal: false, minute: 14, team: 'B' },
      ],
      at: 1000,
    },
    {
      ...
      winnerSide: 'tie',
      goals: [
        { scorerId: 'p5', assisterId: 'p2', ownGoal: false, minute: 17, team: 'A' },
        { scorerId: 'p3', assisterId: null, ownGoal: false, minute: 20, team: 'A' },
        { scorerId: 'p7', assisterId: 'p6', ownGoal: false, minute: 23, team: 'B' },
        { scorerId: 'p9', assisterId: null, ownGoal: false, minute: 26, team: 'B' },
      ],
      penalties: [
    ...
    },
    {
      ...
      winnerSide: 'A',
      goals: [
        { scorerId: 'p1', assisterId: 'p5', ownGoal: false, minute: 29, team: 'A' },
        { scorerId: 'p2', assisterId: null, ownGoal: false, minute: 32, team: 'A' },
        { scorerId: 'p3', assisterId: 'p1', ownGoal: false, minute: 35, team: 'A' },
        { scorerId: 'p4', assisterId: null, ownGoal: false, minute: 38, team: 'A' },
        { scorerId: 'p8', assisterId: null, ownGoal: false, minute: 41, team: 'B' },
        { scorerId: 'p5', assisterId: null, ownGoal: true, minute: 44, team: 'A' },
      ],
      at: 3000,
    },
  ],
