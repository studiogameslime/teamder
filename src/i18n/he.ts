...
export const he = {
  ...
  sendPulseExplain:
    'נשלח הזמנה לשחקנים פנויים באזור המשחק בקבוצות של 10, כל 2 דקות, עד שהמשחק יתמלא או שנגמרו השחקנים (ולכל היותר עד חצי שעה לפני המשחק). כל שחקן מקבל הזמנה אחת בלבד — מי שלא הגיב לא יוצף בעוד הזמנות, ויש תקרה של 3 הזמנות ליום לכל שחקן. ההזמנה מגיעה למי שהדליק "קבלת הזמנות" והמשחק באזור שלו.',
  sendPulseConfirm: 'להתחיל לשלוח?',
  sendPulseStarted: 'התחלנו לשלוח! ההזמנות יֵצאו בפעימות של 10 כל 2 דקות.',
