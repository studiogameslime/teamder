...
export const he = {
  ...
  eventAdd: 'הוסף אירוע',
  eventKindGoal: '⚽ גול',
  eventKindPenalty: '🥅 פנדל',
  eventStepScorer: 'כובש',
  eventStepAssist: 'מבשל',
  eventStepKeeper: 'שוער',
  eventWhoScored: (team: string) => `מי הבקיע? · ${team}`,
  eventWhoKicked: (team: string) => `מי בעט את הפנדל? · ${team}`,
  eventWhoKeeper: 'מי עמד בשער?',
  eventPenaltyResult: 'מה קרה בפנדל?',
  eventPenaltyScored: '✅ נכנס',
  eventPenaltyMissed: '❌ הוחמץ',
  penaltyTag: '🥅',
  penaltyMissedTag: '🥅❌',
  penaltyDeleteTitle: 'מחיקת פנדל',
  penaltyDeleteBody: 'למחוק את הפנדל מהיומן?',
  ...
  statPenRate: 'אחוז הכנסה',
  statPenSaves: 'עצירות פנדל',
  statPenSaveRate: 'אחוז עצירות',
