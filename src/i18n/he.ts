...
export const he = {
  ...
  tipFillerText:
    'כשחסרים שחקנים, האפליקציה מציעה את המשחק לשחקנים מתאימים מחוץ למועדון שלך, באזור שלך. אתה תמיד מאשר ידנית מי מצטרף — אף אחד לא נכנס בלי אישורך. ככה ממלאים שבוע חוסר בלי לרדוף אחרי אנשים.',
  ...
  wentHomeConfirmBody:
    'השחקן יוסר מהקבוצה ולא ישתתף במשחקונים הבאים. אפשר להחזיר אותו בכל רגע.',
  wentHomeConfirmOk: 'הלך הביתה',
  restoreConfirmTitle: (name: string) => `להחזיר את ${name}?`,
  restoreConfirmBody: 'השחקן יחזור לקבוצתו וישתתף במשחקונים הבאים.',
